...
for _ in range(t_num):
    ...
    a_mat3[0, :] = xL_list3[-1][0, 0] - x_list3[-1][0, :] + r_mat3[0, :] - rL_mat3[0, 0] \
                   + vL_list2[-1][0, 0] + vL_list3[-1][0, 0] - 2 * v_list3[-1][0, :] \
                   + xL_list2[-1][0, 0] - x_list3[-1][0, :] + r_mat3[0, :] - rL_mat2[0, 0]
    a_mat3[1, :] = xL_list3[-1][1, 0] - x_list3[-1][1, :] + r_mat3[1, :] - rL_mat3[1, 0] \
                   + vL_list3[-1][1, 0] - v_list3[-1][1, :]
    a_mat3[1, :] *= 5
    ...
    aL_mat2[0, 0] = xL_list3[-1][0, 0] - xL_list2[-1][0, 0] + rL_mat2[0, 0] - rL_mat3[0, 0] \
                    - vL_list2[-1][0, 0] + vL_list3[-1][0, 0] \
                    + xp - xL_list2[-1][0, 0] + rL_mat2[0, 0] - rp + vp - vL_list2[-1][0, 0]
    aL_mat2[1, 0] = xL_list3[-1][1, 0] - xL_list2[-1][1, 0] + rL_mat2[1, 0] - rL_mat2[1, 0] \
                    + vL_list3[-1][1, 0] - vL_list2[-1][1, 0]
