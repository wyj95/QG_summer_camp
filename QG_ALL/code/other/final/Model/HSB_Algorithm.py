...
class HSB:
    def __init__(self, rc=0.5, DP_flag=False):
        ...
        self.rc = rc
        self.location_engine = create_engine(
            "mysql+pymysql://root:3751ueoxjwgixjw3913@39.98.41.126:3306/custom_location")
        self.adjacency_engine = create_engine(
            "mysql+pymysql://root:3751ueoxjwgixjw3913@39.98.41.126:3306/custom_adjacency")
        self.file = ''
        self.x_mat = None
    ...
    def check_in(self, i, vec):
        ...
        :return: True or False --> bool
        """
        return self.get_d(vec, self.x_mat[i, :]) < self.rc and all(self.get_d(vec, self.x_mat[l, :])
